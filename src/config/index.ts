export const PARAMETERS = {
    ...
    DEBUG: import.meta.env.VUE_APP_DEBUG,
    IS_LOCALHOST: import.meta.env.NODE_ENV === 'production' ? 0 : 1, //for debugging outside of Laravel(production), it is set to 1
    BYPASS_UNIQUENESS: import.meta.env.VUE_APP_BYPASS_UNIQUENESS,
    // url production
    ...
    ESRI_TILES_PROVIDER_SATELLITE: 'https://ibasemaps-api.arcgis.com/arcgis/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}?token=' + import.meta.env.VUE_APP_ESRI_API_TOKEN,
    ...
    MAPBOX_TILES_PROVIDER_OUTDOOR: 'https://api.mapbox.com/styles/v1/mapbox/outdoors-v11/tiles/{z}/{x}/{y}?access_token=' + import.meta.env.VUE_APP_MAPBOX_API_TOKEN,
